...
/**
 * Server-optimized ProductCard that receives stock as props.
 * Use this when stock is batch-fetched server-side to avoid N+1 client requests.
 */
export function ProductCardServer({ product, stock, isPriority = false }: ProductCardServerProps) {
